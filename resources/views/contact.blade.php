...
@section('content')
    @if(session('contact'))
        <div class="alert">
            <span class="msg">{{session('contact')}}</span>
            <div class="close-btn">
        ...
        <div class="container-fluid box">
            ...
            <form action="" class="was-validated"  method="POST">
                ...
                <div class="form-group autocomplete"  >
                    ...
                    <input id="myInput" type="text" class=" @error('name') is-invalid @enderror form-control" name="name" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" placeholder="inter name" required>
                    @error('name')
        ...
        <div class="container-fluid box">
            ...
            <form action="" class="was-validated"  method="POST">
                ...
                <div class="form-group autocomplete"  >
                    ...
                    <input id="myInput" type="text" class=" @error('name') is-invalid @enderror form-control" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" name="name" placeholder="ادخل الاسم" required>
