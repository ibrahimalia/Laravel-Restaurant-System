...
<head>
    ...
    <link type="text/css" href="{{ asset('CssNote.css') }}" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="/home/Manage_Page" class="nav-link">Manage</a></li>
                        <li class="nav-item"><a href="/home/category" class="nav-link">Menu</a></li>
                        <li class="nav-item"><a href="/home/sitechange" class="nav-link">Change Location</a></li>
                        <li class="nav-item"><a class='nav-link' href="/home/contact_page">Contact Us</a></li>
                        <li class="nav-item"><a class='nav-link' href="/home/main/calculate">Calculate</a></li>
                        <li class="nav-item">
        ...
        <nav id="navbar" class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="/home/main" class="nav-link fa fa-home fa-2x align-content-center"></a></li>
                        <li class="nav-item"><a href="/home/Manage_Page" class="nav-link">أدارة</a></li>
                        <li class="nav-item"><a href="/home/category" class="nav-link">الوجبات</a></li>
                        <li class="nav-item"><a href="/home/sitechange" class="nav-link">الموقع</a></li>
                        <li class="nav-item"><a class='nav-link' href="/home/contact_page">أرسل لنا</a></li>
                        <li class="nav-item"><a class='nav-link' href="/home/main/calculate">حاسبة التغذية</a></li>
                        <li class="nav-item">
                            <div class="panel-group">
