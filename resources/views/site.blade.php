...
@section('content')
    @if(session('orderError'))
        <div class="alertf">
            <span class="msg">{{session('orderError')}}</span>
            <div class="close-btn">
    ...
    @if(app()->getLocale()=='en')
<div class="container-fluid box" id="map">
    <h1>Select your location:</h1>
    <input  type="number" name="test" value="{{$show}}" hidden>
...
@else
        <div class="container-fluid box" id="map">
            ...
            <form action="" class="was-validated"  method="POST">
                ...
                <button type="submit" v-bind:style="className" class="btn btn-warning">اضف موقعك</button>
