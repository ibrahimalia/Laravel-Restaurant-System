$(document).ready(function () {
    ...
    $('.add').on('click',function (e) {
        ...
        var html=`<tr>
                 ...
                 <td> <input type="number" name="quntites[]" data-price="${price}" class="input" min="1" required ></td>
...
function calculate() {
    ...
    if (p<=0){
        $('.but').removeClass('btn-primary').addClass('btn-default Disabled');
    }else{

        $('.but').removeClass('btn-default Disabled').addClass('btn-primary ');
